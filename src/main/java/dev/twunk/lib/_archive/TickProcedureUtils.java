...
public abstract class TickProcedureUtils {
    ...
    public static boolean setTicking(final Ref<ChunkStore> ref) {
        return TickProcedureUtils.setTicking(ref, true);
    }

    public static boolean setTicking(final Ref<ChunkStore> ref, final boolean ticking) {
    ...
    public static boolean setTicking(final BlockStateInfo info) {
        return TickProcedureUtils.setTicking(info, true);
    }

    public static boolean setTicking(final BlockStateInfo info, final boolean ticking) {
    ...
    public static boolean setTicking(final WorldChunk worldChunk, final Vector3i coords) {
        return TickProcedureUtils.setTicking(worldChunk, coords, true);
    }

    public static boolean setTicking(final WorldChunk worldChunk, final Vector3i coords, final boolean ticking) {
        return worldChunk.setTicking(coords.x, coords.y, coords.z, ticking);
    }

    public static boolean setTicking(final BlockChunk chunk, final BlockStateInfo info, final boolean ticking) {
        final var coords = Coords.Local.get(info);
        return chunk.setTicking(coords.x, coords.y, coords.z, ticking);
    }

    public static boolean setTicking(final BlockChunk chunk, final Vector3i coords) {
        return chunk.setTicking(coords.x, coords.y, coords.z, true);
    }

    public static boolean setTicking(final BlockChunk chunk, final Vector3i coords, final boolean ticking) {
        return chunk.setTicking(coords.x, coords.y, coords.z, ticking);
    }
}
