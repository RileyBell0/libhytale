...
public final class UUIDLookupResource<ECS_TYPE extends WorldProvider> implements Resource<ECS_TYPE> {
    ...
    @Nullable
    public AnyRef<ECS_TYPE> getRefByUUID(UUID uuid) {
    ...
    public static class TrackEntitiesByUUIDSystem<ECS_TYPE extends WorldProvider>
        ...
        public TrackEntitiesByUUIDSystem(IRegistry<ECS_TYPE> registry) {
            ...
            @Nonnull
            var componentType = Objects.requireNonNull(registry.getComponentType(
        ...
        public void onAdd(AnyRef<ECS_TYPE> ref, AddReason reason, CommandBuffer<ECS_TYPE> commandBuffer) {
            @SuppressWarnings("unchecked") final var resource = commandBuffer.getResource(Objects.requireNonNull(this.registry.getResourceType(UUIDLookupResource.class)));
            ...
            @SuppressWarnings("unchecked") final var currentRef = resource.entitiesByUuid.putIfAbsent(uuidComponent.getUuid(), ref);
            if (currentRef != null) {
