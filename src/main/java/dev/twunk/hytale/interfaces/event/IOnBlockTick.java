...
/// Methods for my subsystem version of `ChunkBlockTickSystem.Ticking`
///
...
///
/// My code
/// @see OnTick          - SubSystem used by TickableBlockComponentSystem
...
public interface IOnBlockTick extends IEventConfig<ChunkStore>, IQuery<ChunkStore> {
    void onBlockTick(final BlockRef blockRef, final CommandBuffer<ChunkStore> commandBuffer);
}
