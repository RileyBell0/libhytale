...
/// My code
///
/// @see dev.twunk.hytale.event.OnUniverseTick    - runs IGlobalTickSystem implementors (given that the implementors
...
public interface IOnUniverseTick<ECS_TYPE extends WorldProvider> extends IEventConfig<ECS_TYPE> {
    void onUniverseTick(float dt, int index, Store<ECS_TYPE> store);
}
