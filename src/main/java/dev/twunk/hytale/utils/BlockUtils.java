...
public abstract class BlockUtils {
    ...
    public static List<Boolean> testRefDetection(final Ref<ChunkStore> blockRef) {
        // functions to test
    ...
    public static boolean isBlockRef(final Ref<ChunkStore> ref) {
        return ComponentUtils.has(ref, BLOCK_STATE_INFO_COMPONENT_TYPE);
    }

    public static boolean isChunkRef(final Ref<ChunkStore> ref) {
    ...
    public static final class Coords {
        ...
        public static final class Local {
            ...
            @Nullable
            public static Vector3i get(final Ref<ChunkStore> blockRef) {
                final var info = BlockUtils.Info.get(blockRef);
                if (info == null) {
                    return null;
                }
            ...
            public static Vector3i get(final BlockStateInfo info) {
                // => blockIndex
                return Coords.Local.get(info.getIndex());
            }
            ...
            public static Vector3i get(final Vector3i coords) {
            ...
            //
            // thus, all we need to do is keep x % 32, y, z % 32
            //
            // notably, 32 = 2^5, thus we only need to keep the 5 lowest bits
            public static Vector3i get(final int x, final int y, final int z) {
            ...
            public static Vector3i get(final int blockIndex) {
                ...
                // - thus, every blockIndex is unique ONLY to the chunk it's within
        ...
        public static final class Index {
            ...
            @Nullable
            public static Integer get(final Ref<ChunkStore> blockRef) {
                final var info = BlockUtils.Info.get(blockRef);
                if (info == null) {
                    return null;
                }
            ...
            ///
            /// I mean, fr.
            public static int get(final BlockStateInfo info) {
                return info.getIndex();
            }

            public static int get(final Vector3i coords) {
                return ChunkUtil.indexBlockInColumn(coords.x, coords.y, coords.z);
            }

            public static int get(final int x, final int y, final int z) {
        ...
        public static final class Global {
            ...
            @Nullable
            public static Vector3i get(final Ref<ChunkStore> chunkRef, final Vector3i localCoords) {
            ...
            @Nullable
            public static Vector3i get(final Ref<ChunkStore> chunkRef, final int blockIndex) {
                final var worldChunk = ChunkUtils.WorldChunks.get_chunkRef(chunkRef);
                if (worldChunk == null) {
                    return null;
                }
            ...
            public static Vector3i get(final WorldChunk chunk, final Vector3i localCoords) {
            ...
            public static Vector3i get(final WorldChunk chunk, final int blockIndex) {
                return Coords.Global.get(chunk.getX(), chunk.getZ(), blockIndex);
            }

            // this seems pointless, but it's for anyone who already has a worldChunk, so I don't have to fetch it
            public static Vector3i get(final WorldChunk chunk, final BlockStateInfo info) {
            ...
            public static Vector3i get(final BlockAccessor chunk, final Vector3i localCoords) {
                return Coords.Global.get(chunk.getX(), chunk.getZ(), localCoords);
            }
            ...
            public static Vector3i get(final BlockAccessor chunk, final int blockIndex) {
                return Coords.Global.get(chunk.getX(), chunk.getZ(), blockIndex);
            }

            public static Vector3i get(final BlockAccessor chunk, final BlockStateInfo info) {
                return Coords.Global.get(chunk.getX(), chunk.getZ(), info.getIndex());
            }
            ...
            public static Vector3i get(final BlockChunk chunk, final Vector3i localCoords) {
                return Coords.Global.get(chunk.getX(), chunk.getZ(), localCoords);
            }

            public static Vector3i get(final BlockChunk chunk, final int blockIndex) {
                return Coords.Global.get(chunk.getX(), chunk.getZ(), blockIndex);
            }

            public static Vector3i get(final BlockChunk chunk, final BlockStateInfo info) {
                return Coords.Global.get(chunk.getX(), chunk.getZ(), info.getIndex());
            }
            ...
            public static Vector3i get(final int chunkX, final int chunkZ, final Vector3i localCoords) {
            ...
            public static Vector3i get(final int chunkX, final int chunkZ, final int blockIndex) {
                // remember: 5 bits -> 32
            ...
            public static Vector3i get(final int chunkX, final int chunkZ, final BlockStateInfo info) {
            ...
            // Chunk Coords AND Block Coords
            public static Vector3i get(final long chunkIndex, final Vector3i localCoords) {
            ...
            // Chunk coords AND Block Index
            public static Vector3i get(final long chunkIndex, final int blockIndex) {
            ...
            // Chunk coords AND Block Index
            public static Vector3i get(final long chunkIndex, final BlockStateInfo info) {
                final var blockIndex = info.getIndex();
    ...
    public static final class Refs {
         ...
         */
        public static void testWorldMethods(final World world, final Vector3i coords) {
            try {
                ...
                // this works
                // ```
                // var ref = Ref\_.get(cmd, coords.x, coords.y - 1, coords.z);
                // ```
         ...
         */
        public static List<Ref<ChunkStore>> test(
            ...
            // WorldProvider
            refs.add(Objects.requireNonNull(Refs.get(test.worldProvider, blockCoords)));
            refs.add(Objects.requireNonNull(BlockUtils.Refs.get(test.worldProvider, blockX, blockY, blockZ)));
            refs.add(Objects.requireNonNull(BlockUtils.Refs.get(test.worldProvider, chunkIndex, index)));

            // World
            refs.add(Objects.requireNonNull(BlockUtils.Refs.get(test.world, blockCoords)));
            refs.add(Objects.requireNonNull(Refs.get(test.world, blockX, blockY, blockZ)));
            refs.add(Objects.requireNonNull(BlockUtils.Refs.get(test.world, chunkIndex, index)));

            // CommandBuffer
            refs.add(Objects.requireNonNull(BlockUtils.Refs.get(test.commandBuffer, blockCoords)));
            refs.add(Objects.requireNonNull(BlockUtils.Refs.get(test.commandBuffer, blockX, blockY, blockZ)));
            refs.add(Objects.requireNonNull(BlockUtils.Refs.get(test.commandBuffer, chunkIndex, index)));

            // BlockStateInfo
            refs.add(Objects.requireNonNull(BlockUtils.Refs.get(test.info, blockCoords)));
            refs.add(Objects.requireNonNull(BlockUtils.Refs.get(test.info, blockX, blockY, blockZ)));
            refs.add(Objects.requireNonNull(BlockUtils.Refs.get(test.info, chunkIndex, index)));

            // ChunkRef (global)
            refs.add(Objects.requireNonNull(BlockUtils.Refs.get_chunkRef(test.chunkRef, blockCoords)));
            refs.add(Objects.requireNonNull(BlockUtils.Refs.get_chunkRef(test.chunkRef, blockX, blockY, blockZ)));
            refs.add(Objects.requireNonNull(BlockUtils.Refs.get_chunkRef(test.chunkRef, chunkIndex, index)));
            // ChunkRef (local)
            refs.add(Objects.requireNonNull(BlockUtils.Refs.getLocal(test.chunkRef, blockCoords)));
            refs.add(Objects.requireNonNull(BlockUtils.Refs.getLocal(test.chunkRef, localCoords)));
            refs.add(Objects.requireNonNull(BlockUtils.Refs.getLocal(test.chunkRef, blockX, blockY, blockZ)));
            refs.add(Objects.requireNonNull(BlockUtils.Refs.getLocal(test.chunkRef, localCoords.x, localCoords.y, localCoords.z)));
            refs.add(Objects.requireNonNull(BlockUtils.Refs.getLocal(test.chunkRef, index)));

            // Store
            refs.add(Objects.requireNonNull(BlockUtils.Refs.get(test.store, blockCoords)));
            refs.add(Objects.requireNonNull(BlockUtils.Refs.get(test.store, blockX, blockY, blockZ)));
            refs.add(Objects.requireNonNull(BlockUtils.Refs.get(test.store, chunkIndex, index)));

            // ChunkStore
            refs.add(Objects.requireNonNull(BlockUtils.Refs.get(test.chunkStore, blockCoords)));
            refs.add(Objects.requireNonNull(BlockUtils.Refs.get(test.chunkStore, blockX, blockY, blockZ)));
            refs.add(Objects.requireNonNull(BlockUtils.Refs.get(test.chunkStore, chunkIndex, index)));

            // BlockRef
            refs.add(Objects.requireNonNull(BlockUtils.Refs.get_blockRef(test.blockRef, blockCoords)));
            refs.add(Objects.requireNonNull(BlockUtils.Refs.get_blockRef(test.blockRef, blockX, blockY, blockZ)));
            refs.add(Objects.requireNonNull(BlockUtils.Refs.get_blockRef(test.blockRef, chunkIndex, index)));

            // WorldChunk
            refs.add(Objects.requireNonNull(BlockUtils.Refs.get(test.worldChunk, blockCoords)));
            refs.add(Objects.requireNonNull(BlockUtils.Refs.get(test.worldChunk, blockX, blockY, blockZ)));
            refs.add(Objects.requireNonNull(BlockUtils.Refs.get(test.worldChunk, chunkIndex, index)));
            refs.add(Objects.requireNonNull(BlockUtils.Refs.getLocal(test.worldChunk, blockCoords)));
            refs.add(Objects.requireNonNull(BlockUtils.Refs.getLocal(test.worldChunk, blockX, blockY, blockZ)));
            refs.add(Objects.requireNonNull(BlockUtils.Refs.getLocal(test.worldChunk, index)));

            // BlockComponentChunk
            refs.add(Objects.requireNonNull(BlockUtils.Refs.get(test.blockComponentChunk, index)));
            refs.add(Objects.requireNonNull(BlockUtils.Refs.getLocal(test.blockComponentChunk, blockCoords)));
            refs.add(Objects.requireNonNull(BlockUtils.Refs.getLocal(test.blockComponentChunk, blockX, blockY, blockZ)));
            refs.add(Objects.requireNonNull(BlockUtils.Refs.getLocal(test.blockComponentChunk, index)));
        ...
        @Nullable
        public static Ref<ChunkStore> get_blockRef(final Ref<ChunkStore> blockRef, final Vector3i blockCoords) {
        ...
        // => (ChunkStore, chunkIndex, blockIndex)
        @Nullable
        public static Ref<ChunkStore> get_blockRef(
                final Ref<ChunkStore> blockRef,
                final int blockX,
                final int blockY,
                final int blockZ
        ...
        // => (ChunkStore, chunkIndex, blockIndex)
        @Nullable
        public static Ref<ChunkStore> get(final WorldProvider worldProvider, final Vector3i coords) {
        ...
        // => (ChunkStore, chunkIndex, blockIndex)
        @Nullable
        public static Ref<ChunkStore> get(
        ...
        // => (ChunkStore, chunkIndex, blockIndex)
        @Nullable
        public static Ref<ChunkStore> get(final World world, final Vector3i coords) {
            // return world
            //     .getChunk(Chunk.Coords.Index.getChunkIndex(coords))
            //     .getBlockComponentEntity(coords.x, coords.y, coords.z);
            return BlockUtils.Refs.get2(
        ...
        // => (ChunkStore, chunkIndex, blockIndex)
        @Nullable
        public static Ref<ChunkStore> get(final World world, final long chunkIndex, final int blockIndex) {
            // final var localCoords = BlockCoords.Local.get(blockIndex);
        ...
        // => (ChunkStore, chunkIndex, blockIndex)
        @Nullable
        public static Ref<ChunkStore> get(final CommandBuffer<ChunkStore> commandBuffer, final Vector3i coords) {
            return BlockUtils.Refs.get2(
        ...
        @Nullable
        public static Ref<ChunkStore> get(final BlockStateInfo info, final Vector3i blockCoords) {
            return BlockUtils.Refs.get2(
        ...
        @Nullable
        public static Ref<ChunkStore> get_chunkRef(
        ...
        // => (ChunkStore, chunkIndex, blockIndex)
        @Nullable
        public static Ref<ChunkStore> get(final Store<ChunkStore> store, final Vector3i blockCoords) {
        ...
        // => (ChunkStore, chunkIndex, blockIndex)
        @Nullable
        public static Ref<ChunkStore> get(final ChunkStore chunkStore, final Vector3i blockCoords) {
        ...
        @Nullable
        private static Ref<ChunkStore> get2(
                final ChunkStore chunkStore,
                final long chunkIndex,
                final int blockIndex
        ) {
        ...
        // #region anyLocalRef
        @Nullable
        public static Ref<ChunkStore> getLocal(final Ref<ChunkStore> ref, final Vector3i blockCoords) {
        ...
        @Nullable
        public static Ref<ChunkStore> getLocal(
        ...
        @Nullable
        public static Ref<ChunkStore> getLocal(final Ref<ChunkStore> ref, final int blockIndex) {
            if (BlockUtils.isBlockRef(ref)) {
        ...
        @Nullable
        public static Ref<ChunkStore> getLocal_blockRef(
                final Ref<ChunkStore> blockRef,
                final Vector3i blockCoords
        ) {
        ...
        @Nullable
        public static Ref<ChunkStore> getLocal_blockRef(final Ref<ChunkStore> blockRef, final int blockIndex) {
            final var info = ComponentUtils.get(blockRef, BLOCK_STATE_INFO_COMPONENT_TYPE);
            if (info == null) {
                return null;
            }
        ...
        @Nullable
        public static Ref<ChunkStore> getLocal_chunkRef(
                final Ref<ChunkStore> chunkRef,
                final Vector3i blockCoords
        ) {
        ...
        // ChunkRef => component ON the chunk itself => block ref in the chunk
        @Nullable
        public static Ref<ChunkStore> getLocal_chunkRef(final Ref<ChunkStore> chunkRef, final int blockIndex) {
            return BlockUtils.Refs.getLocal1_chunkRef(chunkRef, blockIndex);
        }

        @Nullable
        private static Ref<ChunkStore> getLocal1_chunkRef(final Ref<ChunkStore> chunkRef, final int blockIndex) {
            final var blockComponentChunk = ComponentUtils.getBlockComponentChunk(chunkRef);
            if (blockComponentChunk == null) {
                return null;
            }
        ...
        @Nullable
        public static Ref<ChunkStore> getLocal(final BlockStateInfo info, final Vector3i blockCoords) {
        ...
        // BlockInfo => ChunkRef => component ON the chunk itself => block ref in the chunk
        @Nullable
        public static Ref<ChunkStore> getLocal(final BlockStateInfo info, final int blockIndex) {
            final var blockComponentChunk = ComponentUtils.getBlockComponentChunk(info.getChunkRef());
            if (blockComponentChunk == null) {
                return null;
            }
        ...
        @Nullable
        public static Ref<ChunkStore> get(final WorldChunk worldChunk, final Vector3i blockCoords) {
            return BlockUtils.Refs.get2(
        ...
        @Nullable
        public static Ref<ChunkStore> getLocal(final WorldChunk worldChunk, final Vector3i blockCoords) {
        ...
        @Nullable
        public static Ref<ChunkStore> getLocal(final WorldChunk worldChunk, final int blockIndex) {
        ...
        @Nullable
        public static Ref<ChunkStore> get(final BlockComponentChunk blockComponentChunk, final int blockIndex) {
            return BlockUtils.Refs.getLocal0(blockComponentChunk, blockIndex);
        }
        ...
        @Nullable
        private static Ref<ChunkStore> getLocal0(
                final BlockComponentChunk blockComponentChunk,
                final int blockIndex
        ) {
    ...
    public static final class Info {
         ...
         */
        public static List<BlockStateInfo> test(
                final CommandBuffer<ChunkStore> commandBuffer,
                final Vector3i providedCoords
        ) {
            final var blockX = providedCoords.x;
            ...
            // WorldProvider
            refs.add(Objects.requireNonNull(Info.get(test.worldProvider, blockCoords)));
            refs.add(Objects.requireNonNull(BlockUtils.Info.get(test.worldProvider, blockX, blockY, blockZ)));
            refs.add(Objects.requireNonNull(BlockUtils.Info.get(test.worldProvider, chunkIndex, localIndex)));

            // World
            refs.add(Objects.requireNonNull(BlockUtils.Info.get(test.world, blockCoords)));
            refs.add(Objects.requireNonNull(BlockUtils.Info.get(test.world, blockX, blockY, blockZ)));
            refs.add(Objects.requireNonNull(BlockUtils.Info.get(test.world, chunkIndex, localIndex)));

            // CommandBuffer
            refs.add(Objects.requireNonNull(BlockUtils.Info.get(test.commandBuffer, blockCoords)));
            refs.add(Objects.requireNonNull(BlockUtils.Info.get(test.commandBuffer, blockX, blockY, blockZ)));
            refs.add(Objects.requireNonNull(BlockUtils.Info.get(test.commandBuffer, chunkIndex, localIndex)));

            // BlockStateInfo
            refs.add(Objects.requireNonNull(BlockUtils.Info.get(test.info, blockCoords)));
            refs.add(Objects.requireNonNull(BlockUtils.Info.get(test.info, blockX, blockY, blockZ)));
            refs.add(Objects.requireNonNull(BlockUtils.Info.get(test.info, chunkIndex, localIndex)));

            // ChunkRef (global)
            // - without specifying that it's a chunk ref we provided, letting the code figure that out
            refs.add(Objects.requireNonNull(BlockUtils.Info.get(test.chunkRef, blockCoords)));
            refs.add(Objects.requireNonNull(BlockUtils.Info.get(test.chunkRef, blockX, blockY, blockZ)));
            refs.add(Objects.requireNonNull(BlockUtils.Info.get(test.chunkRef, chunkIndex, localIndex)));
            // - specifying it's a chunk ref
            refs.add(Objects.requireNonNull(BlockUtils.Info.get_chunkRef(test.chunkRef, blockCoords)));
            refs.add(Objects.requireNonNull(BlockUtils.Info.get_chunkRef(test.chunkRef, blockX, blockY, blockZ)));
            refs.add(Objects.requireNonNull(BlockUtils.Info.get_chunkRef(test.chunkRef, chunkIndex, localIndex)));

            // ChunkRef (local)
            // - without specifying that it's a chunk ref we provided, letting the code figure that out
            refs.add(Objects.requireNonNull(BlockUtils.Info.getLocal(test.chunkRef, localCoords)));
            refs.add(Objects.requireNonNull(BlockUtils.Info.getLocal(test.chunkRef, localCoords.x, localCoords.y, localCoords.z)));
            refs.add(Objects.requireNonNull(BlockUtils.Info.getLocal(test.chunkRef, localIndex)));
            // - specifying it's a chunk ref
            refs.add(Objects.requireNonNull(BlockUtils.Info.getLocal_chunkRef(test.chunkRef, localCoords)));
            refs.add(Objects.requireNonNull(BlockUtils.Info.getLocal_chunkRef(test.chunkRef, localCoords.x, localCoords.y, localCoords.z)));
            refs.add(Objects.requireNonNull(BlockUtils.Info.getLocal_chunkRef(test.chunkRef, localIndex)));

            // Store
            refs.add(Objects.requireNonNull(BlockUtils.Info.get(test.store, blockCoords)));
            refs.add(Objects.requireNonNull(BlockUtils.Info.get(test.store, blockX, blockY, blockZ)));
            refs.add(Objects.requireNonNull(BlockUtils.Info.get(test.store, chunkIndex, localIndex)));

            // ChunkStore
            refs.add(Objects.requireNonNull(BlockUtils.Info.get(test.chunkStore, blockCoords)));
            refs.add(Objects.requireNonNull(BlockUtils.Info.get(test.chunkStore, blockX, blockY, blockZ)));
            refs.add(Objects.requireNonNull(BlockUtils.Info.get(test.chunkStore, chunkIndex, localIndex)));

            // BlockRef
            refs.add(Objects.requireNonNull(BlockUtils.Info.get_blockRef(test.blockRef, blockCoords)));
            refs.add(Objects.requireNonNull(BlockUtils.Info.get_blockRef(test.blockRef, blockX, blockY, blockZ)));
            refs.add(Objects.requireNonNull(BlockUtils.Info.get_chunkRef(test.blockRef, chunkIndex, localIndex)));

            // WorldChunk
            refs.add(Objects.requireNonNull(BlockUtils.Info.get(test.worldChunk, blockCoords)));
            refs.add(Objects.requireNonNull(BlockUtils.Info.get(test.worldChunk, blockX, blockY, blockZ)));
            refs.add(Objects.requireNonNull(BlockUtils.Info.get(test.worldChunk, chunkIndex, localIndex)));
            refs.add(Objects.requireNonNull(BlockUtils.Info.getLocal(test.worldChunk, blockCoords)));
            refs.add(Objects.requireNonNull(BlockUtils.Info.getLocal(test.worldChunk, blockX, blockY, blockZ)));
            refs.add(Objects.requireNonNull(BlockUtils.Info.getLocal(test.worldChunk, localIndex)));

            // BlockComponentChunk
            refs.add(Objects.requireNonNull(BlockUtils.Info.get(test.blockComponentChunk, localIndex)));
            refs.add(Objects.requireNonNull(BlockUtils.Info.getLocal(test.blockComponentChunk, blockCoords)));
            refs.add(Objects.requireNonNull(BlockUtils.Info.getLocal(test.blockComponentChunk, blockX, blockY, blockZ)));
            refs.add(Objects.requireNonNull(BlockUtils.Info.getLocal(test.blockComponentChunk, localIndex)));
        ...
        @Nullable
        public static BlockStateInfo get_blockRef(final Ref<ChunkStore> blockRef, final Vector3i coords) {
            return BlockUtils.Info.get0(BlockUtils.Refs.get_blockRef(blockRef, coords));
        }

        @Nullable
        public static BlockStateInfo get_blockRef(
                final Ref<ChunkStore> blockRef,
                final int x,
                final int y,
                final int z
        ...
        @Nullable
        public static BlockStateInfo get_blockRef(final Ref<ChunkStore> blockRef, final int blockIndex) {
        ...
        @Nullable
        public static BlockStateInfo get(final WorldProvider worldProvider, final Vector3i pos) {
            // => BlockRef
        ...
        @Nullable
        public static BlockStateInfo get(final World world, final Vector3i pos) {
            // => BlockRef
            return BlockUtils.Info.get0(BlockUtils.Refs.get(world, pos));
        }

        @Nullable
        public static BlockStateInfo get(final World world, final int x, final int y, final int z) {
            // => BlockRef
            return BlockUtils.Info.get0(BlockUtils.Refs.get(world, x, y, z));
        }

        @Nullable
        public static BlockStateInfo get(final World world, final long chunkIndex, final int blockIndex) {
            // => BlockRef
        ...
        @Nullable
        public static BlockStateInfo get(final CommandBuffer<ChunkStore> commandBuffer, final Vector3i pos) {
            // => BlockRef
        ...
        @Nullable
        public static BlockStateInfo get(final BlockStateInfo info, final Vector3i blockCoords) {
        ...
        @Nullable
        public static BlockStateInfo get(final BlockStateInfo info, final long chunkIndex, final int blockIndex) {
        ...
        // #region anyRef
        @Nullable
        public static BlockStateInfo get(final Ref<ChunkStore> ref, final Vector3i coords) {
            // Potential: the ref you passed me is a BLOCK ref. slay. that's the good shit. that's what we're after
            final var info = BlockUtils.Info.get(ref);
            if (info != null) {
                return info;
            }

            // If there wasn't a block state info on your ref, we know it's a chunk ref
        ...
        @Nullable
        public static BlockStateInfo get(final Ref<ChunkStore> ref, final long chunkIndex, final int blockIndex) {
            // Potential: the ref you passed me is a BLOCK ref. slay. that's the good shit. that's what we're after
            final var info = BlockUtils.Info.get(ref);
            if (info != null) {
                return info;
        ...
        @Nullable
        public static BlockStateInfo get_chunkRef(final Ref<ChunkStore> chunkRef, final Vector3i coords) {
            return BlockUtils.Info.get0(BlockUtils.Refs.get_chunkRef(chunkRef, coords));
        }

        @Nullable
        public static BlockStateInfo get_chunkRef(
                final Ref<ChunkStore> chunkRef,
                final int x,
                final int y,
                final int z
        ...
        @Nullable
        public static BlockStateInfo get(final WorldChunk worldChunk, final Vector3i blockCoords) {
        ...
        @Nullable
        public static BlockStateInfo getLocal(final WorldChunk worldChunk, final Vector3i blockCoords) {
            return BlockUtils.Info.get(worldChunk.getBlockComponentEntity(blockCoords.x, blockCoords.y, blockCoords.z));
        }

        @Nullable
        public static BlockStateInfo getLocal(
                final WorldChunk worldChunk,
                final int blockX,
                final int blockY,
                final int blockZ
        ...
        @Nullable
        public static BlockStateInfo getLocal(final WorldChunk worldChunk, final int blockIndex) {
            final var localCoords = Coords.Local.get(blockIndex);
        ...
        @Nullable
        public static BlockStateInfo get(final BlockComponentChunk blockComponentChunk, final int blockIndex) {
        ...
        @Nullable
        public static BlockStateInfo get(final Store<ChunkStore> store, final Vector3i pos) {
            // => BlockRef
            return BlockUtils.Info.get0(BlockUtils.Refs.get(store, pos));
        }

        @Nullable
        public static BlockStateInfo get(final Store<ChunkStore> store, final int x, final int y, final int z) {
            // => BlockRef
        ...
        @Nullable
        public static BlockStateInfo get(final ChunkStore chunkStore, final Vector3i pos) {
            // => BlockRef
            return BlockUtils.Info.get0(BlockUtils.Refs.get(chunkStore, pos));
        }

        @Nullable
        public static BlockStateInfo get(final ChunkStore chunkStore, final int x, final int y, final int z) {
            // => BlockRef
        ...
        // ChunkRef => component ON the chunk itself => block ref in the chunk
        @Nullable
        public static BlockStateInfo getLocal_chunkRef(
                final Ref<ChunkStore> chunkRef,
                final Vector3i blockCoords
        ) {
        ...
        // ChunkRef => component ON the chunk itself => block ref in the chunk
        @Nullable
        public static BlockStateInfo getLocal_chunkRef(final Ref<ChunkStore> chunkRef, final int blockIndex) {
        ...
        @Nullable
        public static BlockStateInfo getLocal_blockRef(
                final Ref<ChunkStore> blockRef,
                final Vector3i blockCoords
        ) {
        ...
        // ChunkRef => component ON the chunk itself => block ref in the chunk
        @Nullable
        public static BlockStateInfo getLocal_blockRef(final Ref<ChunkStore> blockRef, final int blockIndex) {
        ...
        @Nullable
        public static BlockStateInfo getLocal(final Ref<ChunkStore> ref, final Vector3i blockCoords) {
            if (BlockUtils.isBlockRef(ref)) {
        ...
        // ChunkRef => component ON the chunk itself => block ref in the chunk
        @Nullable
        public static BlockStateInfo getLocal(final Ref<ChunkStore> ref, final int blockIndex) {
            if (BlockUtils.isBlockRef(ref)) {
        ...
        // BlockInfo => ChunkRef => component ON the chunk itself => block ref in the chunk
        @Nullable
        public static BlockStateInfo getLocal(final BlockStateInfo info, final Vector3i blockCoords) {
        ...
        // BlockInfo => ChunkRef => component ON the chunk itself => block ref in the chunk
        @Nullable
        public static BlockStateInfo getLocal(final BlockStateInfo info, final int blockIndex) {
        ...
        // BlockRef
        @Nullable
        public static BlockStateInfo get(final @Nullable Ref<ChunkStore> blockRef) {
            return BlockUtils.Info.get0(blockRef);
        }

        // BlockRef
        @Nullable
        private static BlockStateInfo get0(final @Nullable Ref<ChunkStore> blockRef) {
            if (blockRef == null) {
                return null;
            }
    ...
    public static final class Id {
        ...
        public static List<Integer> test(
            ...
            // WorldProvider
            refs.add(Objects.requireNonNull(Id.get(test.worldProvider, blockCoords)));
            refs.add(Objects.requireNonNull(BlockUtils.Id.get(test.worldProvider, blockCoords.x, blockCoords.y, blockCoords.z)));
            refs.add(Objects.requireNonNull(BlockUtils.Id.get(test.worldProvider, chunkIndex, blockIndex)));

            //  World
            refs.add(Objects.requireNonNull(BlockUtils.Id.get(test.world, blockCoords)));
            refs.add(Objects.requireNonNull(BlockUtils.Id.get(test.world, blockCoords.x, blockCoords.y, blockCoords.z)));
            refs.add(Objects.requireNonNull(BlockUtils.Id.get(test.world, chunkIndex, blockIndex)));

            //  CommandBuffer
            refs.add(Objects.requireNonNull(BlockUtils.Id.get(test.commandBuffer, blockCoords)));
            refs.add(Objects.requireNonNull(BlockUtils.Id.get(test.commandBuffer, blockCoords.x, blockCoords.y, blockCoords.z))); // test 7 failed
            refs.add(Objects.requireNonNull(BlockUtils.Id.get(test.commandBuffer, chunkIndex, blockIndex)));

            //  Store<ChunkStore>
            refs.add(Objects.requireNonNull(BlockUtils.Id.get(test.store, blockCoords)));
            refs.add(Objects.requireNonNull(BlockUtils.Id.get(test.store, blockCoords.x, blockCoords.y, blockCoords.z))); // test 10 failed
            refs.add(Objects.requireNonNull(BlockUtils.Id.get(test.store, chunkIndex, blockIndex)));

            //  ChunkStore
            refs.add(Objects.requireNonNull(BlockUtils.Id.get(test.chunkStore, blockCoords)));
            refs.add(Objects.requireNonNull(BlockUtils.Id.get(test.chunkStore, blockCoords.x, blockCoords.y, blockCoords.z))); // test 13 failed
            refs.add(Objects.requireNonNull(BlockUtils.Id.get(test.chunkStore, chunkIndex, blockIndex)));

            //  Ref<ChunkStore>
            refs.add(Objects.requireNonNull(BlockUtils.Id.get(test.chunkRef, blockCoords)));
            refs.add(Objects.requireNonNull(BlockUtils.Id.get(test.chunkRef, blockCoords.x, blockCoords.y, blockCoords.z))); // test 16 failed
            refs.add(Objects.requireNonNull(BlockUtils.Id.get(test.chunkRef, chunkIndex, blockIndex)));
        ...
        @Nullable
        public static Integer get(final WorldProvider worldProvider, final Vector3i blockCoords) {
        ...
        @Nullable
        public static Integer get(final World world, final Vector3i blockCoords) {
        ...
        @Nullable
        public static Integer get(final World world, final int blockX, final int blockY, final int blockZ) {
        ...
        @Nullable
        public static Integer get(final World world, final long chunkIndex, final int blockIndex) {
        ...
        @Nullable
        public static Integer get(final CommandBuffer<ChunkStore> commandBuffer, final Vector3i blockCoords) {
        ...
        @Nullable
        public static Integer get(final Store<ChunkStore> store, final Vector3i blockCoords) {
        ...
        @Nullable
        public static Integer get(final Store<ChunkStore> store, final long chunkIndex, final int blockIndex) {
        ...
        @Nullable
        public static Integer get(final ChunkStore chunkStore, final Vector3i blockCoords) {
        ...
        @Nullable
        public static Integer get(final ChunkStore chunkStore, final long chunkIndex, final int blockIndex) {
        ...
        @Nullable
        public static Integer get(final Ref<ChunkStore> chunkRef, final Vector3i blockCoords) {
        ...
        @Nullable
        public static Integer get(final Ref<ChunkStore> chunkRef, final long chunkIndex, final int blockIndex) {
         ...
         */
        public static int get(final String blockId) {
    ...
    public static final class Type {
         ...
         */
        public static List<BlockType> test() {
            final ArrayList<BlockType> refs = new ArrayList<>();

            refs.add(Objects.requireNonNull(BlockUtils.Type.get("TEST_BlockType")));
         ...
         */
        @Nullable
        public static BlockType get(final String blockId) {
            return BlockType.getAssetMap().getAsset(blockId);
        }
    }

    public static boolean set(final World world, final Vector3i blockCoords, final int blockId) {
    ...
    public static boolean set0(final WorldChunk chunk, final Vector3i blockCoords, final int blockId) {
        return chunk.setBlock(blockCoords.x, blockCoords.y, blockCoords.z, blockId);
    }

    public static int get(final World world, final Vector3i blockCoords) {
        var chunk = ChunkUtils.WorldChunks.get(world, blockCoords);
        if (chunk == null) {
            return -1;
        }
    ...
    public static int get0(final WorldChunk chunk, final Vector3i blockCoords) {
