...
public abstract class ChunkUtils {
    ...
    public static final class Coords {
        ...
        public static final class Global {
            ...
            public static void test(final Vector3i providedCoords) {
            ...
            public static ChunkCoordinates get(final int blockX, final int blockZ) {
                // see ChunkUtil.chunkCoordinate
                return new ChunkCoordinates(blockX >> 5, blockZ >> 5);
            }

            // With GLOBAL block coords
            public static ChunkCoordinates get(final Vector3i blockCoords) {
                // see ChunkUtil.chunkCoordinate
            ...
            public static Vector2i getVector2i(final int blockX, final int blockZ) {
                // see ChunkUtil.chunkCoordinate
            ...
            ///
            /// returned "y" in vector is actually the chunk's "z" coordinate
            public static Vector2i getVector2i(final Vector3i blockCoords) {
                // see ChunkUtil.chunkCoordinate
        ...
        // ====================================================================
        // Chunk Index (index is interchangeable with coordinates) FROM block coordinates
        // ====================================================================
        ...
        public static final class Index {
            ...
            public static void test(
                ...
                if (!nullableTestIndex.equals(chunkIndex)) {
            ...
            @Nullable
            public static Long get(final Ref<ChunkStore> anyRef) {
            ...
            @Nullable
            public static Long get(final BlockStateInfo info) {
                return ChunkUtils.Coords.Index.get_chunkRef(info.getChunkRef());
            }

            @Nullable
            public static Long get_chunkRef(final Ref<ChunkStore> chunkRef) {
            ...
            @Nullable
            public static Long get_blockRef(final Ref<ChunkStore> blockRef) {
            ...
            public static long get(final WorldChunk worldChunk) {
                return worldChunk.getIndex();
            }
            ...
            public static long get(final int blockX, final int blockZ) {
                // see ChunkUtil.indexChunkFromBlock
                return ((long) (blockX >> 5) << 32) | ((blockZ >> 5) & 4294967295L);
            }

            public static long get(final Vector3i blockCoords) {
                // see ChunkUtil.indexChunkFromBlock
                return ((long) (blockCoords.x >> 5) << 32) | ((blockCoords.z >> 5) & 4294967295L);
            }

            public static long get_chunkCoords(final int chunkX, final int chunkZ) {
                // see ChunkUtil.indexChunkFromBlock
                return ((long) chunkX << 32) | (chunkZ & 4294967295L);
            }

            public static long get_chunkCoords(final ChunkCoordinates coords) {
                // see ChunkUtil.indexChunkFromBlock
             ...
             */
            public static long get_chunkCoords(final Vector2i chunkCoords) {
                // see ChunkUtil.indexChunkFromBlock
    ...
    public static final class WorldChunks {
         ...
         */
        public static List<WorldChunk> test(
                final Ref<ChunkStore> blockRef,
                final CommandBuffer<ChunkStore> commandBuffer,
                final Vector3i providedCoords
        ) {
            ...
            refs.add(Objects.requireNonNull(WorldChunks.get_chunkRef(test.chunkRef)));
            refs.add(Objects.requireNonNull(WorldChunks.get_blockRef(test.blockRef)));
            // - with: block ref (auto)
            refs.add(Objects.requireNonNull(WorldChunks.get(blockRef)));
            // - with: chunk ref (auto)
            refs.add(Objects.requireNonNull(WorldChunks.get(test.chunkRef)));
            refs.add(Objects.requireNonNull(WorldChunks.get(test.info)));

            // WorldProvider
            refs.add(Objects.requireNonNull(WorldChunks.get(test.worldProvider, test.blockChunk)));
            refs.add(Objects.requireNonNull(WorldChunks.get(test.worldProvider, blockX, blockZ)));
            refs.add(Objects.requireNonNull(WorldChunks.get(test.worldProvider, chunkIndex)));
            refs.add(Objects.requireNonNull(WorldChunks.get(test.worldProvider, blockCoords)));
            refs.add(Objects.requireNonNull(WorldChunks.get_chunkCoords(test.worldProvider, chunkX, chunkZ)));

            // World
            refs.add(Objects.requireNonNull(WorldChunks.get(test.world, test.blockChunk)));
            refs.add(Objects.requireNonNull(WorldChunks.get(test.world, blockX, blockZ)));
            refs.add(Objects.requireNonNull(WorldChunks.get(test.world, chunkIndex)));
            refs.add(Objects.requireNonNull(WorldChunks.get(test.world, blockCoords)));
            refs.add(Objects.requireNonNull(WorldChunks.get_chunkCoords(test.world, chunkX, chunkZ)));

            // BlockRef
            refs.add(Objects.requireNonNull(WorldChunks.get(blockRef, test.blockChunk)));
            refs.add(Objects.requireNonNull(WorldChunks.get(blockRef, blockX, blockZ)));
            refs.add(Objects.requireNonNull(WorldChunks.get(blockRef, chunkIndex)));
            refs.add(Objects.requireNonNull(WorldChunks.get(blockRef, blockCoords)));
            refs.add(Objects.requireNonNull(WorldChunks.get_chunkCoords(blockRef, chunkX, chunkZ)));

            // Info
            refs.add(Objects.requireNonNull(WorldChunks.get(test.info, test.blockChunk)));
            refs.add(Objects.requireNonNull(WorldChunks.get(test.info, blockX, blockZ)));
            refs.add(Objects.requireNonNull(WorldChunks.get(test.info, chunkIndex)));
            refs.add(Objects.requireNonNull(WorldChunks.get(test.info, blockCoords)));
            refs.add(Objects.requireNonNull(WorldChunks.get_chunkCoords(test.info, chunkX, chunkZ)));

            // CommandBuffer
            refs.add(Objects.requireNonNull(WorldChunks.get(test.commandBuffer, test.blockChunk)));
            refs.add(Objects.requireNonNull(WorldChunks.get(test.commandBuffer, blockX, blockZ)));
            refs.add(Objects.requireNonNull(WorldChunks.get(test.commandBuffer, chunkIndex)));
            refs.add(Objects.requireNonNull(WorldChunks.get(test.commandBuffer, blockCoords)));
            refs.add(Objects.requireNonNull(WorldChunks.get_chunkCoords(test.commandBuffer, chunkX, chunkZ)));

            // Store
            refs.add(Objects.requireNonNull(WorldChunks.get(test.store, test.blockChunk)));
            refs.add(Objects.requireNonNull(WorldChunks.get(test.store, blockX, blockZ)));
            refs.add(Objects.requireNonNull(WorldChunks.get(test.store, chunkIndex)));
            refs.add(Objects.requireNonNull(WorldChunks.get(test.store, blockCoords)));
            refs.add(Objects.requireNonNull(WorldChunks.get_chunkCoords(test.store, chunkX, chunkZ)));

            // ChunKStore
            refs.add(Objects.requireNonNull(WorldChunks.get(test.chunkStore, test.blockChunk)));
            refs.add(Objects.requireNonNull(WorldChunks.get(test.chunkStore, blockX, blockZ)));
            refs.add(Objects.requireNonNull(WorldChunks.get(test.chunkStore, chunkIndex)));
            refs.add(Objects.requireNonNull(WorldChunks.get(test.chunkStore, blockCoords)));
            refs.add(Objects.requireNonNull(WorldChunks.get_chunkCoords(test.chunkStore, chunkX, chunkZ)));

            // final test -> does it matter really if we pass a chunk ref or a block ref?
            // update: NO HECKING WAY, it doesn't. wild.
            refs.add(Objects.requireNonNull(WorldChunks.get(blockRef, chunkIndex)));
            refs.add(Objects.requireNonNull(WorldChunks.get(test.chunkRef, chunkIndex)));
        ...
        @Nullable
        public static WorldChunk get_chunkRef(final Ref<ChunkStore> chunkRef) {
            return ComponentUtils.get(chunkRef, WORLD_CHUNK_COMPONENT);
        }

        @Nullable
        public static WorldChunk get_blockRef(final Ref<ChunkStore> blockRef) {
        ...
        @Nullable
        public static WorldChunk get(final Ref<ChunkStore> anyRef) {
            // Potential 1: The ref you passed me is a CHUNK ref. slay. that's the good shit. that's what we're after
        ...
        @Nullable
        public static WorldChunk get(final BlockStateInfo info) {
            return ComponentUtils.get(info.getChunkRef(), WORLD_CHUNK_COMPONENT);
        }
        ...
        @Nullable
        public static WorldChunk get(final WorldProvider worldProvider, final BlockChunk blockChunk) {
            return ChunkUtils.WorldChunks.get(worldProvider, blockChunk.getIndex());
        }

        @Nullable
        public static WorldChunk get(final WorldProvider worldProvider, final int blockX, final int blockZ) {
            return ChunkUtils.WorldChunks.get(worldProvider, ChunkUtils.Coords.Index.get(blockX, blockZ));
        }

        @Nullable
        public static WorldChunk get(final WorldProvider worldProvider, final Vector3i blockCoords) {
            return ChunkUtils.WorldChunks.get(worldProvider, ChunkUtils.Coords.Index.get(blockCoords));
        }

        @Nullable
        public static WorldChunk get_chunkCoords(
        ...
        @Nullable
        public static WorldChunk get(final WorldProvider worldProvider, final long chunkIndex) {
        ...
        @Nullable
        public static WorldChunk get(final World world, final BlockChunk blockChunk) {
            return ChunkUtils.WorldChunks.get(world, blockChunk.getIndex());
        }

        @Nullable
        public static WorldChunk get(final World world, final int blockX, final int blockZ) {
            return ChunkUtils.WorldChunks.get(world, ChunkUtils.Coords.Index.get(blockX, blockZ));
        }

        @Nullable
        public static WorldChunk get(final World world, final Vector3i blockCoords) {
            return ChunkUtils.WorldChunks.get(world, ChunkUtils.Coords.Index.get(blockCoords));
        }

        @Nullable
        public static WorldChunk get_chunkCoords(final World world, final int chunkX, final int chunkZ) {
            return ChunkUtils.WorldChunks.get(world, ChunkUtils.Coords.Index.get_chunkCoords(chunkX, chunkZ));
        }

        @Nullable
        public static WorldChunk get(final World world, final long chunkIndex) {
        ...
        @Nullable
        public static WorldChunk get(final Ref<ChunkStore> anyRef, final BlockChunk blockChunk) {
            return ChunkUtils.WorldChunks.get(anyRef, blockChunk.getIndex());
        }

        @Nullable
        public static WorldChunk get(final Ref<ChunkStore> anyRef, final int blockX, final int blockZ) {
            return ChunkUtils.WorldChunks.get(anyRef, ChunkUtils.Coords.Index.get(blockX, blockZ));
        }

        @Nullable
        public static WorldChunk get(final Ref<ChunkStore> anyRef, final Vector3i blockCoords) {
        ...
        @Nullable
        public static WorldChunk get(final Ref<ChunkStore> anyRef, final long chunkIndex) {
        ...
        @Nullable
        public static WorldChunk get(final BlockStateInfo info, final BlockChunk blockChunk) {
        ...
        @Nullable
        public static WorldChunk get(final BlockStateInfo info, final int blockX, final int blockZ) {
            return ChunkUtils.WorldChunks.get(info, ChunkUtils.Coords.Index.get(blockX, blockZ));
        }

        @Nullable
        public static WorldChunk get(final BlockStateInfo info, final Vector3i blockCoords) {
            return ChunkUtils.WorldChunks.get(info, ChunkUtils.Coords.Index.get(blockCoords));
        }

        @Nullable
        public static WorldChunk get_chunkCoords(final BlockStateInfo info, final int chunkX, final int chunkZ) {
        ...
        /// Then uses the world to get the WorldChunk at the coords provided
        @Nullable
        public static WorldChunk get(final BlockStateInfo info, final long chunkIndex) {
        ...
        @Nullable
        public static WorldChunk get(final CommandBuffer<ChunkStore> commandBuffer, final Vector3i blockCoords) {
        ...
        @Nullable
        public static WorldChunk get(final Store<ChunkStore> store, final BlockChunk blockChunk) {
            return ChunkUtils.WorldChunks.get(store, blockChunk.getIndex());
        }

        @Nullable
        public static WorldChunk get(final Store<ChunkStore> store, final int blockX, final int blockZ) {
            return ChunkUtils.WorldChunks.get(store, ChunkUtils.Coords.Index.get(blockX, blockZ));
        }

        @Nullable
        public static WorldChunk get(final Store<ChunkStore> store, final Vector3i blockCoords) {
        ...
        @Nullable
        public static WorldChunk get(final Store<ChunkStore> store, final long chunkIndex) {
        ...
        @Nullable
        public static WorldChunk get(final ChunkStore chunkStore, final BlockChunk blockChunk) {
        ...
        @Nullable
        public static WorldChunk get(final ChunkStore chunkStore, final int blockX, final int blockZ) {
            // ALT version: `chunkStore.getWorld().getChunk(blockChunk.getIndex());`
            return ChunkUtils.WorldChunks.get(chunkStore, ChunkUtils.Coords.Index.get(blockX, blockZ));
        }

        @Nullable
        public static WorldChunk get(final ChunkStore chunkStore, final Vector3i blockCoords) {
        ...
        @Nullable
        public static WorldChunk get(final ChunkStore chunkStore, final long chunkIndex) {
            // ALT version: `chunkStore.getWorld().getChunk(blockChunk.getIndex());`
    ...
    public static final class Refs {
        ...
        public static List<Ref<ChunkStore>> test(
            ...
            // World
            refs.add(Objects.requireNonNull(ChunkUtils.Refs.get(test.world, blockCoords)));
            refs.add(Objects.requireNonNull(ChunkUtils.Refs.get(test.world, blockX, blockZ)));
            refs.add(Objects.requireNonNull(ChunkUtils.Refs.get(test.world, chunkIndex)));
            refs.add(Objects.requireNonNull(ChunkUtils.Refs.get_chunkCoords(test.world, chunkX, chunkZ)));

            refs.add(Objects.requireNonNull(ChunkUtils.Refs.get(test.commandBuffer, blockCoords)));
            refs.add(Objects.requireNonNull(ChunkUtils.Refs.get(test.commandBuffer, blockX, blockZ)));
            refs.add(Objects.requireNonNull(ChunkUtils.Refs.get(test.commandBuffer, chunkIndex)));
            refs.add(Objects.requireNonNull(ChunkUtils.Refs.get_chunkCoords(test.commandBuffer, chunkX, chunkZ)));

            refs.add(Objects.requireNonNull(ChunkUtils.Refs.get(test.store, blockCoords)));
            refs.add(Objects.requireNonNull(ChunkUtils.Refs.get(test.store, blockX, blockZ)));
            refs.add(Objects.requireNonNull(ChunkUtils.Refs.get(test.store, chunkIndex)));
            refs.add(Objects.requireNonNull(ChunkUtils.Refs.get_chunkCoords(test.store, chunkX, chunkZ)));

            refs.add(Objects.requireNonNull(ChunkUtils.Refs.get(test.chunkStore, blockCoords)));
            refs.add(Objects.requireNonNull(ChunkUtils.Refs.get(test.chunkStore, blockX, blockZ)));
            refs.add(Objects.requireNonNull(ChunkUtils.Refs.get(test.chunkStore, chunkIndex)));
            refs.add(Objects.requireNonNull(ChunkUtils.Refs.get_chunkCoords(test.chunkStore, chunkX, chunkZ)));

            refs.add(Objects.requireNonNull(ChunkUtils.Refs.get(test.chunkRef, blockCoords)));
            refs.add(Objects.requireNonNull(ChunkUtils.Refs.get(test.chunkRef, blockX, blockZ)));
            refs.add(Objects.requireNonNull(ChunkUtils.Refs.get(test.chunkRef, chunkIndex)));
            refs.add(Objects.requireNonNull(ChunkUtils.Refs.get_chunkCoords(test.chunkRef, chunkX, chunkZ)));

            refs.add(Objects.requireNonNull(ChunkUtils.Refs.get(test.info, blockCoords)));
            refs.add(Objects.requireNonNull(ChunkUtils.Refs.get(test.info, blockX, blockZ)));
            refs.add(Objects.requireNonNull(ChunkUtils.Refs.get(test.info, chunkIndex)));
            refs.add(Objects.requireNonNull(ChunkUtils.Refs.get_chunkCoords(test.info, chunkX, chunkZ)));

            refs.add(Objects.requireNonNull(ChunkUtils.Refs.get(test.blockRef)));
            refs.add(Objects.requireNonNull(ChunkUtils.Refs.get(test.info)));
        ...
        ///   the world, etc.
        /// - Easy to get the chunk a block is in via several methods (BlockStateInfo, accessing the world, etc.)
        ...
        /// - Chunk coordinates (x and z of a chunk itself)
        ///
        /// NOTE
        ...
        // ====================================================================
        @Nullable
        public static Ref<ChunkStore> get(final World world, final Vector3i blockCoords) {
            return ChunkUtils.Refs.get(world, ChunkUtils.Coords.Index.get(blockCoords));
        }

        @Nullable
        public static Ref<ChunkStore> get(final World world, final int blockX, final int blockZ) {
            return ChunkUtils.Refs.get(world, ChunkUtils.Coords.Index.get(blockX, blockZ));
        }

        @Nullable
        public static Ref<ChunkStore> get_chunkCoords(final World world, final int chunkX, final int chunkZ) {
            return ChunkUtils.Refs.get(world, ChunkUtils.Coords.Index.get_chunkCoords(chunkX, chunkZ));
        }

        @Nullable
        public static Ref<ChunkStore> get(final World world, final long chunkIndex) {
        ...
        @Nullable
        public static Ref<ChunkStore> get_chunkCoords(
                final CommandBuffer<ChunkStore> commandBuffer,
                final int chunkX,
                final int chunkZ
        ) {
        ...
        @Nullable
        public static Ref<ChunkStore> get(final CommandBuffer<ChunkStore> commandBuffer, final long chunkIndex) {
        ...
        @Nullable
        public static Ref<ChunkStore> get(final Store<ChunkStore> store, final int blockX, final int blockZ) {
        ...
        @Nullable
        public static Ref<ChunkStore> get(final Store<ChunkStore> store, final long chunkIndex) {
        ...
        @Nullable
        public static Ref<ChunkStore> get(final ChunkStore chunkStore, final int blockX, final int blockZ) {
        ...
        @Nullable
        public static Ref<ChunkStore> get(final ChunkStore chunkStore, final long chunkIndex) {
        ...
        @Nullable
        public static Ref<ChunkStore> get(final Ref<ChunkStore> chunkRef, final Vector3i blockCoords) {
            return ChunkUtils.Refs.get(chunkRef, ChunkUtils.Coords.Index.get(blockCoords));
        }

        @Nullable
        public static Ref<ChunkStore> get(final Ref<ChunkStore> chunkRef, final int blockX, final int blockZ) {
        ...
        @Nullable
        public static Ref<ChunkStore> get(final Ref<ChunkStore> chunkRef, final long chunkIndex) {
        ...
        @Nullable
        public static Ref<ChunkStore> get(final BlockStateInfo info, final int blockX, final int blockZ) {
        ...
        @Nullable
        public static Ref<ChunkStore> get(final BlockStateInfo info, final long chunkIndex) {
        ...
        @Nullable
        public static Ref<ChunkStore> get(final Ref<ChunkStore> blockRef) {
            final var info = BlockUtils.Info.get(blockRef);
            if (info == null) {
                return null;
            }
        ...
        public static Ref<ChunkStore> get(final BlockStateInfo info) {
            return info.getChunkRef();
        }
